...
import com.example.springbootmockapi.services.comedian.ComedianService;
...
public class ComedianController {
    ...
    public ResponseEntity<Object> newComedian(@RequestBody Comedian newComedian) {
    ...
    public ResponseEntity<Object> deleteComedian(@PathVariable Long id) {
